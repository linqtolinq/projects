...
{
    public class MQTTGrpcService : HookProvider.HookProviderBase
    {
        ...
        {
            //_logger.LogInformation($"OnSessionSubscribed:{request.Topic}");
            //Console.WriteLine(request.ToString());
            EmptySuccess reply = new EmptySuccess();
            return Task.FromResult(reply);
        }
        ...
        /// <param name="request"></param>
        /// <param name="context"></param>
        /// { "message": { "node": "emqx@127.0.0.1", "id": "0005F2DA5BC3858FF4420000681D0000", "from": "api_example_client", "topic": "api/example/topic", "payload": "aGVsbG8gZW1xeCBhcGk=", "timestamp": "1674394539885" }, "meta": { "node": "emqx@127.0.0.1", "version": "5.0.11", "sysdescr": "EMQX", "clusterName": "emqxcl" } }
        /// <returns></returns>
